            ...
            <section class="py-5">
                <div class="container px-5 mb-5">
                    <div class="text-center mb-5">
                        <h1 class="display-5 fw-bolder mb-0"><span class="text-gradient d-inline">Volunteer</span></h1>
                    </div>
                    ...
                    <table class="table">
                        ...
                        <?php
                            $img_source = "";
                            $results_2 = mysqli_query($con, "select * from tbl_user where u_role = 2");
                            $counter = 1;
                        ...
                        ?>
                            <tr>
                                ...
                                <td>
                                    <img src="images/<?php echo $row[10]; ?>" style="width: 100px; height: 80px;">
                                </td>
                                <td>
                                    <?php
                                        $task_assigned = mysqli_query($con, "SELECT t_id FROM tbl_task WHERE t_task_assigned_person = '$row[0]'");
                                        $row2 = mysqli_fetch_row($task_assigned);
                                        if(isset($row2[0]) == 0)
                                            echo "Not Assigned";
                                        else
                                            echo $row2[0];
